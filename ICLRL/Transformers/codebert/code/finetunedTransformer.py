...
class Config:
    ...
    # Paths
    DATA_PATH = "E:/models/workB/ICLRW/data/assembly2025.csv"
    SAVE_DIR = "E:/models/workB/ICLRW/Transformers/codebert/results/seedbert1"
    METRICS_FILE = "E:/models/workB/ICLRW/Transformers/codebert/results/seedbert1/training_metrics.csv"
...
class AssemblyClassifier(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        return self.classifier(pooled_output), outputs.attentions
