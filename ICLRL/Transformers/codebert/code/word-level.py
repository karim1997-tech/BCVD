...
class Config:
    MODEL_NAMES = {
        'codebert': 'google-bert/bert-base-uncased'    # 'codebert': 'microsoft/codebert-base'
    }
    ...
    WEIGHT_DECAY = 0.01
    WARMUP_STEPS = 100
    seeds = [42,50,60,70,213,718,920,1020,7800,8000,450]
    # Paths
    DATA_PATH = "E:/models/workB/ICLRL/data/assembly2025.csv"
    SAVE_DIR = "E:/models/workB/ICLRL/Transformers/codebert/results-WordLevel-bert/seed1"
    METRICS_FILE = "E:/models/workB/ICLRL/Transformers/codebert/results-WordLevel-bert/seed1/training_metrics.csv"
...
class AssemblyClassifier(nn.Module):
    def __init__(self, model_name, n_classes=2, freeze_bert=False):
        ...
        if freeze_bert:
            ...
            # for layer in self.transformer.encoder.layer[:8]:
    ...
    def forward(self, input_ids, attention_mask):
        # Get all token embeddings [batch, seq_len, hidden_size]
